...
## time require to produce:
0. template and tech choose -> 1.5 h 
1. Api ask for countries and render on main site -> 1.5 h
2. Styles -> 3h
3. Search input -> 1h
4. filters by region -> 1h

## tech that i will use:
1. Typescript
2. Scss
3. HTML (no need to use templates like Nunjucs)
4. vite as builder